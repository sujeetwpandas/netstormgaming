             <?php get_header();
/*Template Name: Kahnawake Service */
   ?>
   <style type="text/css">
...
<?php endif; ?>
    <!-- End Services Details Area -->
            <!-- Start Servics Style One 
    ============================================= -->
<?php if ( have_rows( 'section_-_6_options_2' ) ) : ?>
    <?php while ( have_rows( 'section_-_6_options_2' ) ) : the_row(); ?>
...
$category_slug = 'kahnawake'; // Replace with your category slug
