...
<?php endif; ?>
    <!-- End About -->
            <!-- Star Services Details Area
    ============================================= -->
<?php if ( have_rows( 'section_-_right_image_full_width_2' ) ) : ?>
    <?php while ( have_rows( 'section_-_right_image_full_width_2' ) ) : the_row(); ?>
        <?php $section_4_title2 = get_sub_field( 'section_4_title' ); ?>
        <?php if ( trim( $section_4_title2 ) !== '' ) : ?>
...
<?php endif; ?>
    <!-- End Services Details Area -->
                    <!-- Star Services Details Area
   ============================================= -->
<?php if ( have_rows( 'paragraph_text_1_' ) ) : ?>
    <?php while ( have_rows( 'paragraph_text_1_' ) ) : the_row(); ?>
...
<!-- End Services Details Area -->
        <!-- Star Services Details Area
    ============================================= -->
<?php if ( have_rows( 'section_-_left_image_full_width_2' ) ) : ?>
    <?php while ( have_rows( 'section_-_left_image_full_width_2' ) ) : the_row(); ?>
        <?php $title02 = get_sub_field( 'title' ); ?>
        <?php if ( trim( $title02 ) !== '' ) : ?>
...
<?php if ( have_rows( 'paragraph_text_2' ) ) : ?>
    <?php while ( have_rows( 'paragraph_text_2' ) ) : the_row(); ?>
        <?php $titles03 = get_sub_field( 'title' ); ?>
        <?php if ( trim( $titles03 ) !== '' ) : ?>
<div class="services-details-area overflow-hidden default-padding bg-gray">
   <div class="container">
      <div class="services-details-items">
         <div class="row">
...
$category_slug = 'malta'; // Replace with your category slug
