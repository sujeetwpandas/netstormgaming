    <?php get_header('lp');
/*Template Name: Netstorm Landing Page */
   ?>
   <style type="text/css">
       .thumb img {
    height: auto;
                        ...
                        <div class="row align-center">
                            <div class="col-xl-7">
                                <div class="content" style="padding-top: 20px; padding-bottom: 20px">
                                    <h2><?php the_sub_field( 'banner_sub-title_1' ); ?></h2>
                                    <h3><?php the_sub_field( 'main_heading_1' ); ?></h3>
    ...
    <div class="about-style-one-area default-padding">
       ...
       <?php endif; ?>
            ...
            <?php while ( have_rows( 'about_card' ) ) : the_row(); ?>
                       ...
                       <div class="about-card wow fadeInUp" data-wow-delay="100ms">
                <ul>
                                <li>
                    ...
                    <div class="tab-content134 services-tab-content" id="nav-tabContent2">
                        ...
                        <div class="tab-pane fade show active" id="tab001" role="tabpanel" aria-labelledby="nav-id-1">
                            <div class="row">
                                ...
                                <!-- End Single Item -->
                                <!-- Single Item -->
                                <div class="col-lg-4 col-md-6 mt-60 mt-md-30 mt-xs-30 wow fadeInUp" data-wow-delay="100ms">
                                    <div class="services-style-one">
                                        <?php
                                            // Get the icon field value (change 'icon_field' to your actual ACF field name)
    ...
    <div class="services-style-two-area bottom-less bg-cover" style="background-image: url(<?php echo get_stylesheet_directory_uri(); ?>/assets/img/shape/27.png); padding-top: 80px; padding-bottom: 80px;">
        ...
        <?php endif; ?>
                            <div class="title">
                                    ...
                                    <h4><?php the_sub_field( 'section_11_tab_2_title' ); ?></h4>
        ...
        <?php endif; ?>
                            <div class="title">
                                    ...
                                    <h4><?php the_sub_field( 'section_11_tab_3_title' ); ?></h4>
        ...
        <?php endif; ?>
                            <div class="title">
                                    ...
                                    <h4><?php the_sub_field( 'section_11_tab_4_title' ); ?></h4>
	...
	<?php while ( have_rows( 'why_choose_us' ) ) : the_row(); ?>
        ...
        <?php if ( trim( $w_title_1 ) !== '' ) : ?>
            <div class="about-style-one-area default-padding choose-business">
              <div class="container">
                 <h4 class="section-title"><?php the_sub_field( 'w_title_1' ); ?></h4>
   ...
   <div
    ...
    >
      <div class="disclaimer-box">
        <h4 class="disclaimer-title sub-title"><?php the_sub_field( 'disclaimer_title' ); ?></h4>
