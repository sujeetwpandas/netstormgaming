             <?php get_header();
/*Template Name: Turnkey solution */
   ?>
   <style type="text/css">
...
<?php endif; ?>
    ...
    <?php while ( have_rows( 'section_-_call_to_action' ) ) : the_row(); ?>
        <?php $section_title1s = get_sub_field( 'section_title' ); ?>
        <?php if ( trim( $section_title1s ) !== '' ) : ?>
...
<?php endif; ?>
    ...
    <div class="services-style-one-area default-padding bg-gray icon_img">
        <div class="center-shape" style="background-image: url(<?php echo get_stylesheet_directory_uri(); ?>/assets/img/shape/5.png);"></div>
        <div class="container">
            <div class="site-heading text-center">
                        <!-- <h4 class="sub-heading">Our Process</h4> -->
...
$category_slug = 'turnkey-solution'; // Replace with your category slug
