                                 ...
                                 <div class="col-lg-4 col-md-6 mt-60 mt-md-30 mt-xs-30 wow fadeInUp" data-wow-delay="700ms">
                                    <div class="services-style-one">
                                        <?php
                                            ...
                                            ?>
                                        <h4> <?php the_sub_field( 'tab_4_title' ); ?></h4>
                                ...
                                <div class="col-lg-4 col-md-6 mt-60 mt-md-30 mt-xs-30">
                                    <div class="services-style-one">
                                        <?php
                                            ...
                                            ?>
                                        <h4> <?php the_sub_field( 'tab_5_title' ); ?></h4>
                                ...
                                <div class="col-lg-4 col-md-6 mt-60 mt-md-30 mt-xs-30">
                                    <div class="services-style-one">
                                        <?php
                                            ...
                                            ?>
                                        <h4> <?php the_sub_field( 'tab_6_title' ); ?></h4>
...
<?php endif; ?>
    ...
    <?php while ( have_rows( 'section_-_6_options' ) ) : the_row(); ?>
        <?php $section_5_title = get_sub_field( 'section_5_title' ); ?>
        <?php if ( trim( $section_5_title ) !== '' ) : ?>
...
<?php endif; ?>
    ...
    <?php while ( have_rows( 'section_-_3_options_with_2_pragraph' ) ) : the_row(); ?>
        <?php $section_6_title = get_sub_field( 'section_6_title' ); ?>
        <?php if ( trim( $section_6_title ) !== '' ) : ?>
                                ...
                                <div class="row relative">
                                    ...
                                    <div class="col-lg-6 col-md-6 mb-30">
                                        <div class="feature-style-two">
                                            ...
                                            <?php
                                            // Get the icon field value (change 'icon_field' to your actual ACF field name)
                                            $icon_field = get_sub_field('icons_01');
                                    ...
                                    <div class="col-lg-6 col-md-6 mb-30">
                                        <div class="feature-style-two">
                                           ...
                                           <?php
                                            // Get the icon field value (change 'icon_field' to your actual ACF field name)
                                            $icon_field = get_sub_field('icons_02');
                                    ...
                                    <!-- <div class="col-lg-4 col-md-6 mb-30">
                                        <div class="feature-style-two">
                                            ...
                                            <?php
                                            // Get the icon field value (change 'icon_field' to your actual ACF field name)
                                            $icon_field = get_sub_field('icons_03');
...
<?php endif; ?>
    <!-- End About -->
        <!-- Star Services Details Area
    ============================================= -->
<?php if ( have_rows( 'suspension_&_revocation' ) ) : ?>
    <?php while ( have_rows( 'suspension_&_revocation' ) ) : the_row(); ?>
        <?php $title = get_sub_field( 'title' ); ?>
        <?php if ( trim( $title ) !== '' ) : ?>
...
<?php endif; ?>
    <!-- End Services Details Area -->
        <!-- Star Services Details Area
    ============================================= -->
<?php if ( have_rows( 'cost_of_curacao_license_cost' ) ) : ?>
    <?php while ( have_rows( 'cost_of_curacao_license_cost' ) ) : the_row(); ?>
...
<?php endif; ?>
    <!-- End Services Details Area -->
            <!-- Star Services Details Area
    ============================================= -->
<?php if ( have_rows( 'ongoing_maintenance' ) ) : ?>
    <?php while ( have_rows( 'ongoing_maintenance' ) ) : the_row(); ?>
...
<?php endif; ?>
    ...
    <?php while ( have_rows( 'section_-_faq' ) ) : the_row(); ?>
        <?php $section_10_sub_title = get_sub_field( 'section_10_sub_title' ); ?>
        <?php if ( trim( $section_10_sub_title ) !== '' ) : ?>
    <div class="faq-area default-padding bg-gray1">
        <!-- End Shape -->
        <div class="container">
            <div class="row">
...
$category_slug = 'curacao'; // Replace with your category slug
...
<?php endif; ?>
    ...
    <div class="contact-style-one-area overflow-hidden default-padding bg-gray1">
        ...
        <div class="container">
            <div class="row align-center">
                ...
                <div class="contact-stye-one col-lg-5 mb-md-50 mb-xs-20">
                    ...
                    <div class="contact-style-one-info"><?php the_sub_field( 'section_12_heading' ); ?>
                        <ul>
                ...
                <div class="contact-stye-one col-lg-7 pl-60 pl-md-15 pl-xs-15">
                    <div class="contact-form-style-one">
                        ...
                        echo do_shortcode('[contact-form-7 id="2c466ae" title="New Curacao Enquiry Form"]');
                        // ?>
                    </div>
                </div>
