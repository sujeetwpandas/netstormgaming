...
.col-xl-6.col-lg-6.order-lg-last.pl-50.pl-md-15.pl-xs-15.pdbt.pdrt.pdlftzro {
    padding-right: 30px;
}
.icon_img img {
    width: 70px;
...
<?php endif; ?>
    ...
    <?php while ( have_rows( 'section_-_6_option_with_icon' ) ) : the_row(); ?>
        <?php $section_3_titles = get_sub_field( 'section_3_title' ); ?>
        <?php if ( trim( $section_3_titles ) !== '' ) : ?>
...
<?php endif; ?>
    ...
    <?php while ( have_rows( 'section-_left_image_1' ) ) : the_row(); ?>
        <?php $section_2_titles = get_sub_field( 'section_2_title' ); ?>
        <?php if ( trim( $section_2_titles ) !== '' ) : ?>
...
<?php endif; ?>
    ...
    <?php while ( have_rows( 'section_-_right_image_full_width_' ) ) : the_row(); ?>
        <?php $section_4_titles = get_sub_field( 'section_4_title' ); ?>
        <?php if ( trim( $section_4_titles ) !== '' ) : ?>
    <div class="services-details-area overflow-hidden default-padding1 bg-gray1">
        <div class="container-fluid">
            <div class="services-details-items">
                <div class="row">
                    
                    <div class="col-xl-6 col-lg-6 order-lg-last pl-md-15 pl-xs-15 pdbt pdlt pdtop">
                        <div class="site-heading">
                            <h2 class="title"><?php the_sub_field( 'section_4_title' ); ?></h2>
                            <div class="devider"></div>
                        </div>
                        
                        <div class="features mt-40 mt-xs-30 mb-30s mb-xs-20">
                            <div class="row">
                                    <div class="content">
...
<?php endif; ?>
    ...
    <?php while ( have_rows( 'section_-_left_image_full_width' ) ) : the_row(); ?>
        <?php $titles1 = get_sub_field( 'title' ); ?>
        <?php if ( trim( $titles1 ) !== '' ) : ?>
    <div class="services-details-area overflow-hidden default-padding2 bg-gray">
        ...
        <?php endif; ?>
                    ...
                    <div class="col-xl-6 col-lg-6 order-lg-last pl-50 pl-md-15 pl-xs-15 pdbt pdrt pdlftzro">
                        <div class="site-heading">
...
<?php endif; ?>
    ...
    <?php while ( have_rows( 'section_-_6_options' ) ) : the_row(); ?>
        <?php $section_5_titles1 = get_sub_field( 'section_5_title' ); ?>
        <?php if ( trim( $section_5_titles1 ) !== '' ) : ?>
...
<!-- Star Services Details Area
    ...
    <?php while ( have_rows( 'section_-_vertical_tab' ) ) : the_row(); ?>
        <?php $section_title01 = get_sub_field( 'section_title' ); ?>
        <?php if ( trim( $section_title01 ) !== '' ) : ?>
            ...
            <div class="row">
                ...
                <div class="col-xl-8 col-lg-7 order-lg-last pl-50 pl-md-15 pl-xs-15">
                    <div class="thumb">
                        ...
                        <div class="tab-content1" id="privacy-tab" style="display: none;"> <!-- Tab 3 -->
                            <?php the_sub_field( 'tab_4_content' ); ?>
                        </div>
                        <div class="tab-content1" id="cookie-tab" style="display: none;"> <!-- Tab 3 -->
                            <?php the_sub_field( 'tab_5_content' ); ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-4 col-lg-5 mt-md-120 mt-xs-50 services-sidebar">
                    ...
                    <div class="single-widget services-list-widget tabs2">
                        <h4 class="widget-title"><?php the_sub_field( 'section_title' ); ?></h4>
                        <div class="content">
                            <ul>
                                ...
                                <li data-tab="privacy-tab"><a href="javascript:void(0);"><?php the_sub_field( 'tab_4_title' ); ?> </a></li>
                                <li data-tab="cookie-tab"><a href="javascript:void(0);"><?php the_sub_field( 'tab_5_title' ); ?> </a></li>
                            </ul>
                        </div>
                    </div>
                    <!-- End Single Widget -->
...
<script>
    ...
    <?php while ( have_rows( 'section_-_call_to_action' ) ) : the_row(); ?>
        <?php $section_title02 = get_sub_field( 'section_title' ); ?>
        <?php if ( trim( $section_title02 ) !== '' ) : ?>
...
<?php if ( have_rows( 'section_-_6_option_with_icon_2' ) ) : ?>
    <?php while ( have_rows( 'section_-_6_option_with_icon_2' ) ) : the_row(); ?>
        <?php $section_3_title02 = get_sub_field( 'section_3_title' ); ?>
        <?php if ( trim( $section_3_title02 ) !== '' ) : ?>
    <div class="services-style-one-area default-padding bg-gray1 icon_img">
        <div class="center-shape" style="background-image: url(<?php echo get_stylesheet_directory_uri(); ?>/assets/img/shape/5.png);"></div>
        <div class="container">
            <div class="site-heading text-center">
                        <!-- <h4 class="sub-heading">Our Process</h4> -->
...
<?php endif; ?>
    ...
    <?php while ( have_rows( 'section_-_faq' ) ) : the_row(); ?>
        <?php $section_10_title02 = get_sub_field( 'section_10_title' ); ?>
        <?php if ( trim( $section_10_title02 ) !== '' ) : ?>
...
$category_slug = 'compliance'; // Replace with your category slug
...
<?php endif; ?>
    ...
    <?php while ( have_rows( 'section_-_service_options' ) ) : the_row(); ?>
        <?php $section_11_title02 = get_sub_field( 'section_11_title' ); ?>
        <?php if ( trim( $section_11_title02 ) !== '' ) : ?>
