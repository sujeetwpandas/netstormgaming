...
<?php endif; ?>
    ...
    <?php while ( have_rows( 'section_-_vertical_tab' ) ) : the_row(); ?>
        <?php $section_9_tab_1_title = get_sub_field( 'section_9_tab_1_title' ); ?>
        <?php if ( trim( $section_9_tab_1_title ) !== '' ) : ?>
...
<?php endif; ?>
    ...
    <?php while ( have_rows( 'section_-_form' ) ) : the_row(); ?>
        <?php $section_12_heading = get_sub_field( 'section_12_heading' ); ?>
        <?php if ( trim( $section_12_heading ) !== '' ) : ?>
                ...
                <div class="contact-stye-one col-lg-7 pl-60 pl-md-15 pl-xs-15">
                    <div class="contact-form-style-one">
                        ...
                        <?php //echo do_shortcode('[contact-form-7 id="2d49c70" title="Contact page enquiry form"]');
                         echo do_shortcode('[contact-form-7 id="32bb3e3" title="New Enquiry Form"]'); ?>
                    </div>
                </div>
